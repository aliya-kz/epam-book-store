    ...
    <form action="<%=request.getContextPath()%>/controller" method="post">
        <div class="nav-container">
            <nav class="nav-menu">
                <ul>
                    <li>
                        <button name="service_name" value="get_all_books"><c:out value="${books}"/></button>
                    </li>
                    <li>
                        <button name="service_name" value="get_all_categories"><c:out value="${categories}"/></button>
                    </li>
                    <li>
                        <button name="service_name" value="get_all_users"><c:out value="${users}"/></button>
                    </li>
                    <li>
                        <button name="service_name" value="get_all_orders"><c:out value="${ords}"/></button>
                    </li>
                    <li>
                        <button name="service_name" value="get_all_authors"><c:out value="${authors}"/></button>
                    </li>
                </ul>
            </nav>
        </div>

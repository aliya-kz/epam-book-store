                ...
                <div class="book-info">
                    ...
                    <section class="book-info-table">
                        ...
                        <form action="<%=request.getContextPath()%>/controller?id=${book.id}" method="post">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    ...
                                    <input type="hidden" name="uri" value="<%=request.getRequestURI()%>"/>
                                    <button class="add-book-btn" name="service_name" value="add_to_cart"><c:out
                                            value="${add_to_cart}"/>
                                    </button>
                                    <br>
                                </c:otherwise>
                        ...
                        <c:if test="${msg != null && msg == added}">
                            <div class="btns">
                                <a href="/cart">
                                    <div id="view-cart" class="btn"><c:out value="${view_cart}"/></div>
                                </a>
                                <a href="/checkout">
                                    <div id="checkout" class="btn"><c:out value="${checkout}"/></div>
                                </a>
                            </div>
                        </c:if>
                    </section>
